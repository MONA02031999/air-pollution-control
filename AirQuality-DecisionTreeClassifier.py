...
for city in ['bj','ld'] :
    ...
    for pre_days in pre_days_list :
        for loss_function in loss_functions :
            ...
            print("Use day model : %r, city %s pre_days %d loss_function %s use_day_model" %(use_day_model, city, pre_days, loss_function))
            ...
            if use_day_model : 
                traing_result = "Use day model, city %s pre_days %d loss_function %s aver_smapes_best, best_sampe = %.5f\n" %(city, pre_days, loss_function, aver_smapes_best)
            else :
                traing_result = "Use hour model, city %s pre_days %d loss_function %s aver_smapes_best,  best_sampe = %.5f\n" %(city, pre_days, loss_function, aver_smapes_best)
            print(traing_result)
